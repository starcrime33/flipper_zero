...
$image =  "https://github.com/starcrime33/flipper_zero/blob/main/jumpscare.png"


$i = -join($image,"?dl=1")
iwr $i -O $env:TMP\i.png

iwr https://github.com/starcrime33/flipper_zero/blob/main/jumpscare.png?dl=1 -O $env:TMP\i.png
